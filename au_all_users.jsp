      ...
      <div class="mainbar">
        <div class="article">
          ...
          <%
					...
					%>
          <tr>
            <td  valign="baseline" height="0"><p class="style22 style4 style5 style8">&nbsp;</p>
                <div align="center" class="style22 style4 style5 style8">
                  <%out.println(i);%>
                  <p>&nbsp; </p>
                </div></td>
            <td width="122" rowspan="1" ><div class="style22 style4 style5 style8" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                <input  name="image" type="image" src="u_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;">
            </a> </div></td>
            <td  valign="baseline" height="0"><p class="style22 style4 style8 style8">&nbsp;</p>
                <div align="center" class="style22 style4 style8 style8">
            ...
            <%
						...
						%>
            <td  width="111" valign="baseline" height="0" style="color:#000000;"align="center"><div align="center" class="style22 style4 style8 style8">
                <p>&nbsp;</p>
            ...
            <%
						...
						{
						%>
            <td width="63" height="0"  valign="baseline"><p class="style22 style4 style8 style8">&nbsp;</p>
                <div align="center" class="style22 style4 style8 style8">
                  <%out.println(s7);%>
            </div></td>
            <%
