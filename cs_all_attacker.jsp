...
With User Centric Access Control</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style4"> View All Attacker Details [ <a href="cs_chart4.jsp">View in Chart</a> ]</h2>
          <p align="center">&nbsp;</p>
          ...
          <%
					...
					%>
          <tr>
            <td  valign="baseline" height="0"><p class="style22 style4 style7">&nbsp;</p>
                <div align="center" class="style22 style4 style7">
                  <%out.println(i);%>
                  <p>&nbsp; </p>
                </div></td>
            
            <td  valign="baseline" height="0"><p class="style4 style22 style7">&nbsp;</p>
                <div align="center" class="style22 style4 style7 style9 style7">
                  <%out.println(s3);%>
                  <p>&nbsp; </p>
                </div></td>
            <td  valign="baseline" height="0"><p class="style4 style22 style7">&nbsp;</p>
                <div align="center" class="style22 style4 style9 style7">
                  <%out.println(s2);%>
                  <p>&nbsp; </p>
                </div></td>
            <td  valign="baseline" height="0"><p class="style4 style22 style7">&nbsp;</p>
			...
			<td  valign="baseline" height="0"><p class="style4 style22 style7">&nbsp;</p>
                <div align="center" class="style22 style4 style15 style7">
                  <%out.println(s5);%>
                  <p>&nbsp; </p>
                </div></td>
          </tr>
