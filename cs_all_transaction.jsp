...
<table width="694" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
	...
	<td width="155" bgcolor="#FF0000"><div align="center" class="style7 style6 style1"><strong>User / Owner</strong></div></td>
...
<%
		...
		%>  <tr>
		<td height="29">
		<div align="center" class="style10 style5 style10"><strong><%=i%></strong></div>		</td>
		<td height="29">
		<div align="center" class="style10 style5 style10"><strong><%=s2%></strong></div>		</td>
		<td>
		<div align="center" class="style10 style5 style10"><strong><%=s3%></strong></div>		</td>
		<td>
		<div align="center" class="style10 style5 style10"><strong><%=s4%></strong></div>		</td>
		<td>
		<div align="center" class="style8 style5 style10"><%=s5%></div>		</td>
