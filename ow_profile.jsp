    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <table width="547" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            ...
            <tr>
              <td  width="145" height="40" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="left" class="style14 style15 style20 style8 style9 style5 style3" style="margin-left:20px;"><strong>Owner Name </strong></div></td>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="ow_main.jsp"><span>Owner Main</span></a></li>
