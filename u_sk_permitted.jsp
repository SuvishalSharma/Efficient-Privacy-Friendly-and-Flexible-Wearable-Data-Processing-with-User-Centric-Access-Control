...
try 
{
	...
	while ( rs.next() )
	{
		...
		%>
            <tr>
              <td  width="50" height="51" valign="middle"><div align="center" class="style4"><%out.println(s1);%></div></td>
			  <td  width="50" height="51" valign="middle"><div align="center" class="style4"><%out.println(ds4);%></div></td>
<td align="center"  width="50" height="51" valign="middle"><div align="center" class="style4"><a href="u_sk_permitted11.jsp?pname=<%=s1%>&fname=<%=ds4%>">Download</a></div></td>
            </tr>
            <%
						}
						}
