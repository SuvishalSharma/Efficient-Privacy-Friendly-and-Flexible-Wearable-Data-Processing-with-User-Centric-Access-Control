  ...
  <tr>
	...
	<tr>
	  ...
	  <div align="center" class="style8 style3"><%=s2%></div>		</td>
		<td height="80">
	  <div align="center" class="style8 style3"><input  name="image" type="image" src="patient_Pic.jsp?id=<%=i%>" style="width:90px; height:90px;"></div> </td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys3%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys4%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys5%></div>		</td>
		<td height="80">
	  <div align="center" class="style8 style3"><%=decrys6%></div>		</td>
		<td height="80">
	  <div align="center" class="style8 style3"><%=decrys7%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys8%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys9%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys10%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><%=decrys11%></div>		</td>
		<td>
	  <div align="center" class="style8 style3"><a href="ow_view_file.jsp?fname=<%=s12%>&pname=<%=s2%>"><%=decrys12%></a></div>		</td>
	</tr>
